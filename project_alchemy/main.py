...
from project_alchemy.crud.lessons import create_lesson  # Updated import
...
with Session() as session:
    ...
    session.commit()
    new_lesson = create_lesson(session=session, subject='Math', date=datetime.now(), teacher_id=new_teacher.teacher_id)
